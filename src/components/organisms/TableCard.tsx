...
export const TableCard = memo(function TableCard({ table, refs, isSelected, isHighlighted, onSelect, onDragStart }: TableCardProps) {
  ...
  return (
    <div
      style={{ 
        ...
        top: table.y, 
        width: 260,
        zIndex: isHighlighted ? 50 : isSelected ? 10 : 1
      }}
    ...
    >
      ...
      <div className={cn(
        ...
        <span className={cn("text-[10px] opacity-60", isHighlighted ? "text-amber-300" : isSelected ? "text-amber-400" : "text-zinc-500")}>⊞</span>
